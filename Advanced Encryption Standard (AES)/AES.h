 ...
 * Date:            2/17/2023
 * 
 * Synopsis:        This file contains AES class attributes and method declarations. 
*/
...
class AES
{
    private:
        ...
        void initKey(string, bool);
        void initRcon(int);
        uint8_t sBoxSub(uint8_t);
        uint8_t InvsBoxSub(uint8_t);


    public:
        AES(string, string, bool); // Constructor
        void Cipher(); // Cipher
